...
category: Algorithms
---
Selection Sort - מיון בחירה, הינו האלגוריתם האינטואיטיבי ביותר (לפחות לפי דעתי). אלגוריתם זה משתמש במבנה הנתונים הבסיסי והידוע - [מערך]({% post_url 2013-02-17-array | relative_url %}).
