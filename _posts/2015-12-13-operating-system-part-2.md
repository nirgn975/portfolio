...
## <span style="text-decoration: underline;"><strong>1. תהליכים (Processes)</strong></span>
...
[<img class="alignleft wp-image-2319" src="http://www.lifelongstudent.net/wp-content/uploads/2015/10/Interrupt_Processor.jpeg" alt="Interrupt Processor" width="300" height="301" srcset="http://www.lifelongstudent.net/wp-content/uploads/2015/10/Interrupt_Processor.jpeg 618w, http://www.lifelongstudent.net/wp-content/uploads/2015/10/Interrupt_Processor-150x150.jpeg 150w, http://www.lifelongstudent.net/wp-content/uploads/2015/10/Interrupt_Processor-300x300.jpeg 300w" sizes="(max-width: 300px) 100vw, 300px" />](http://www.lifelongstudent.net/wp-content/uploads/2015/10/Interrupt_Processor.jpeg)המעבר הזה, לביצוע של השגרה לטיפול בפסיקות, יוצר תקורה, מכיוון שצריך לבצע שמירת תוכן של התהליך על מנת לאפשר שחזור של ביצוע התוכנית מהנקודה שבה הופסקה. שמירת התוכן מתבצעת ע"י החומרה ותלויה במעבד (שלב 6 באיור משמאל). שמירת ה PSW וה PC מתבצעת גם ע"י המעבד עצמו (שלב 4) אשר קורא לשגרה לטיפול בפסיקות (בשלב 5). תהליך השמירה עצמו מתואר בצורה סכמתית באיור משמאל (בעקבות ריבוי הארכיטקטורות השונות של המעבד, ייתכנו גם אפשרויות נוספות).
...
[<img class="alignleft wp-image-2327" src="http://www.lifelongstudent.net/wp-content/uploads/2015/11/finite_state_machine.png" alt="finite-state machine" width="300" height="166" srcset="http://www.lifelongstudent.net/wp-content/uploads/2015/11/finite_state_machine.png 850w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/finite_state_machine-150x83.png 150w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/finite_state_machine-300x166.png 300w" sizes="(max-width: 300px) 100vw, 300px" />](http://www.lifelongstudent.net/wp-content/uploads/2015/11/finite_state_machine.png)מודל התהליכים מתאפיין בהגדרה של מבנה היררכי בין תהליכי מערכת ההפעלה. אחד המרכיבים החשובים ביותר של מודל התהליכים הוא **מכונת מצבים**, המתארת את תקופת חייו של התהליך.
...
[<img class="alignleft wp-image-2330" src="http://www.lifelongstudent.net/wp-content/uploads/2015/11/CPU_Utilization.jpeg" alt="CPU Utilization" width="300" height="172" srcset="http://www.lifelongstudent.net/wp-content/uploads/2015/11/CPU_Utilization.jpeg 1342w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/CPU_Utilization-150x86.jpeg 150w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/CPU_Utilization-300x172.jpeg 300w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/CPU_Utilization-1024x588.jpeg 1024w" sizes="(max-width: 300px) 100vw, 300px" />](http://www.lifelongstudent.net/wp-content/uploads/2015/11/CPU_Utilization.jpeg)כמו שאמרנו, העלאת רמת המקביליות של המערכת מביאה לניצול טוב יותר של המשאבים. נניח שתהליך מבלה חלק מזמנו בפעולת קלט / פלט (ז"א 0 < p וגם 1 > p). כאשר n תהליכים נמצאים בזיכרון בבת אחת, ההסתברות לכך שכל התהליכים מבצעים פעולת קלט / פלט היא p^n (בהנחה שהתהליכים אינם תלויים זה בזה). בתנאים אלה, ההסתברות לכך שהמעבד פעיל היא 1 פחות p^n (וזאת הנוסחה לחישוב הניצולת של המעבד).
...
## <span style="text-decoration: underline;"><strong>2. תהליכונים (Threads)</strong></span>
...
<span style="text-decoration: underline;"><strong>מימוש תהליכונים</strong></span>
...
## **<span style="text-decoration: underline;">3. תקשורת בין תהליכים</span>**
...
<pre class="lang:c decode:true">deleteFirst(){
...
[<img class="alignleft wp-image-2336" src="http://www.lifelongstudent.net/wp-content/uploads/2015/11/Critical_Race.jpeg" alt="Critical Race" width="300" height="148" srcset="http://www.lifelongstudent.net/wp-content/uploads/2015/11/Critical_Race.jpeg 2600w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/Critical_Race-150x74.jpeg 150w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/Critical_Race-300x148.jpeg 300w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/Critical_Race-1024x505.jpeg 1024w" sizes="(max-width: 300px) 100vw, 300px" />](http://www.lifelongstudent.net/wp-content/uploads/2015/11/Critical_Race.jpeg)התוצאה הרצויה היא ששני התהליכונים ימחקו מראש הרשימה שני איברים ראשונים. אך נניח שבתור ישנם ארבעה עצמים. תהליכון 1 מגיע לפרוצדורה ()deleteFirst ומבצע את השורה הראשונה. לאחר ביצוע השורה, מתרחשת החלפת תהליכונים ותהליכון 2 מגיע לפונ' ()deleteFirst שלו ומבצע גם כן את השורה הראשונה. נניח שהתלהיכונים ממשיכים להתחלף כל שורה. באיור משמאל (חלק b) ניתן לראות מה מתרחש בתור לאחר שהתהליכונים ביצעו את השורה השנייה. ובחלק האחרון, c, ניתן לראות כי לאחר שהתהליכונים סיימו לבצע (כל אחד את העותק שלו של ()deleteFirst. הרי לכל תהליכון יש מחסנית נפרדת, ולכן עותקים נפרדים של הפרוצדורה רצים במקביל, המשתנה TmpNodePtr הוא משתנה מקומי ולכן בתמונה משמאל אנו רואים 2 כאלו -עותקים נפרדים שלו יפיעו בכל מחסנית. המשתנה ListNodePtr הוא משתנה גלובלי בספרייה ולכן הוא משותף לשני התהליכונים), רק איבר אחד נמחק מהרשימה.
...
<pre class="lang:c decode:true">boolean interested[2];
in turn;
...
<pre class="lang:c decode:true">int TSL (int lock){
    if (lock == 0){
        lock = 1;
        return 0;
    }
...
[<img class="alignleft wp-image-2348" src="http://www.lifelongstudent.net/wp-content/uploads/2015/11/Screenshot-from-2015-11-21-11-13-49.jpeg" alt="producer-consumer problem" width="350" height="309" srcset="http://www.lifelongstudent.net/wp-content/uploads/2015/11/Screenshot-from-2015-11-21-11-13-49.jpeg 1269w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/Screenshot-from-2015-11-21-11-13-49-150x133.jpeg 150w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/Screenshot-from-2015-11-21-11-13-49-300x265.jpeg 300w, http://www.lifelongstudent.net/wp-content/uploads/2015/11/Screenshot-from-2015-11-21-11-13-49-1024x905.jpeg 1024w" sizes="(max-width: 350px) 100vw, 350px" />](http://www.lifelongstudent.net/wp-content/uploads/2015/11/Screenshot-from-2015-11-21-11-13-49.jpeg)כדי לעקוב אחר מס' הפריטים במאגר נשתמש במונה, count. ונניח שהמאגר יכול להכיל N פריטים. היצרן בודק האם count שווה ל N, ואם זה המצב הוא הולך לישון, אחרת הוא מאחסן פריט ומגדיל את המונה בהתאם. היצרן גם דואג לקרוא ל WAKEUP כדי להעיר את הצרכן כאשר הוא מאחסן את הפריט הראשון, כי במקרה שהמאגר היה ריק והיצרן אכסן פריט חדש, הוא צריך לגרום לצרכן להתעורר על מנת לאפשר מחדש עבודה במקביל.
...
<pre class="lang:c decode:true ">down(s){
    if (s == 0)
...
<pre class="lang:c decode:true ">meesage msg;
while (true){
	... // non critical section
...
<pre class="lang:c decode:true">main(){
	message token;
...
<h2 dir="rtl">
  <span style="text-decoration: underline;"><strong>5. בעיות IPC קלאסיות</strong></span>
</h2>
...
<a href="https://en.wikipedia.org/wiki/Dining_philosophers_problem" target="_blank">הבעיה המפורסמת ביותר</a><a href="https://en.wikipedia.org/wiki/Dining_philosophers_problem" target="_blank"><img class="alignleft wp-image-2364" src="http://www.lifelongstudent.net/wp-content/uploads/2015/12/Dining_philosophers.png" alt="Dining Philosophers" width="200" height="207" srcset="http://www.lifelongstudent.net/wp-content/uploads/2015/12/Dining_philosophers.png 1130w, http://www.lifelongstudent.net/wp-content/uploads/2015/12/Dining_philosophers-145x150.png 145w, http://www.lifelongstudent.net/wp-content/uploads/2015/12/Dining_philosophers-289x300.png 289w, http://www.lifelongstudent.net/wp-content/uploads/2015/12/Dining_philosophers-768x797.png 768w, http://www.lifelongstudent.net/wp-content/uploads/2015/12/Dining_philosophers-987x1024.png 987w" sizes="(max-width: 200px) 100vw, 200px" /></a> בהקשר זה, והפתרון שלה משמש כמודל שבאמצעותו בוחנים יעילות של מנגנונים חדשים לתקשורת בין תהליכים בסביבה בעלת מספר מוגבל של משאבים (כמו התקני קלט / פלט).
